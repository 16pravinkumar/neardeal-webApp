...
const EditAdd = () => {
    ...
    const handleSubmit = async () => {
        console.log(image);
        try {
            const response = await fetch('https://wellness.neardeal.me/WAPI/createAdsMW.php', {
                method: 'POST',
                headers: {
        ...
        <div style={{ display: 'flex' }}>
            ...
            <div className="create-package" style={{ width: '80%' }}>
                <span className="heading">
                    <Link to="/campaign"><img src={leftArrow} alt="left arrow" /></Link> Activate Ads
                </span>

                <div>
                    <div className="left">
                        <button className="btn-outline-secondary border-0 active me-2" onClick={() => setActive('content')} style={{ textDecoration: 'none' }}>Content</button>
                    </div>
                    ...
                    <motion.div initial={{ opacity: 0 }}
                        ...
                        <div className="body">
                            ...
                            <div style={{ flexDirection: 'column', position: 'relative', width: '60%' }}>
                                ...
                                <img style={{ position: 'absolute', textAlign: 'center', left: '35%', top: '10%', borderRadius: '10px', width: '25%' }} src={aaaa} alt="logo" />
                            ...
                            <div style={{ justifyContent: 'start', marginTop: '20px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column' }}>
                                    <label htmlFor='startDate' className="grey">Start Date:</label>
                                    <input id="startDate" type='date' style={{ padding: '10px 20px', border: '1px solid #E9ECEE', borderRadius: '10px', color: '#637381' }} value={startDate} onChange={(e) => setStartDate(e.target.value)} />
                                </div>

                                <div style={{ margin: '0px 10px', display: 'flex', flexDirection: 'column' }}>
                                    <label htmlFor='endDate' className="grey">End Date:</label>
                                    <input id="endDate" type='date' style={{ padding: '10px 20px', border: '1px solid #E9ECEE', borderRadius: '10px', color: '#637381' }} value={endDate} onChange={(e) => setEndDate(e.target.value)} />
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <span style={{ marginTop: '20px', fontWeight: 'bold', fontSize: '20px' }}>Select file</span>
                                <p className="grey">Drop file here or click <span style={{ color: '#00A76F' }}>browse</span> through your machine</p>
                                <input
                                    type="file"
                                    accept="image/*"
