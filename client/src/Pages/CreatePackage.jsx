      ...
      >
        ...
        <div className="container mainSec" id="bookingSec">
          ...
          <div className="package-body">
                      ...
                      >
                        <div>
                          <div className="toggle-switch">
                            ...
                            ></label>
                            <span>
                              {item.Status == 1 ? "Published" : "Draft Saved"}
                            </span>
                          </div>
                        </div>
                        <div
                          onClick={(e) =>
                            navigate(`/package/${item.InventoryID}`)
                          }
                        >
            ...
            <div
              className="spa"
              onClick={() => handleAccordionToggle("massage")}
            >
              <div style={{ width: "10%" }}>
                <img
                  src={play}
                  className={`play-icon ${
                    expandedSection === "massage" ? "rotate" : ""
                  }`}
                  alt="play"
                />
            ...
            <div
              className={`accordion-content ${
                expandedSection === "massage" ? "expanded" : ""
              }`}
            >
              <div className="item">
                <div className="left" style={{ width: "84%" }}>
            ...
            <div
              className={`accordion-content ${
                expandedSection === "sauna" ? "expanded" : ""
              }`}
            >
              <div className="item">
                <div className="left" style={{ width: "84%" }}>
